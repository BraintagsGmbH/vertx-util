...
public class TestCollectionAsync<T> extends AbstractCollectionAsync<T> {
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.vertx.util.util.CollectionAsync#iterator()
   */
  @Override
  ...
  class TestIterator implements IteratorAsync<T> {
     ...
     * (non-Javadoc)
     * 
     * @see de.braintags.vertx.util.util.IteratorAsync#hasNext()
     */
    @Override
     ...
     * (non-Javadoc)
     * 
     * @see de.braintags.vertx.util.util.IteratorAsync#next(io.vertx.core.Handler)
     */
    @Override
