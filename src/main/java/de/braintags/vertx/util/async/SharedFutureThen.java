...
class SharedFutureThen<U, T> extends SharedFutureImpl<U> implements SharedFuture<U> {

  private final Function<AsyncResult<T>, Future<U>> mapper;

  public SharedFutureThen(final Future<T> src, final Function<AsyncResult<T>, Future<U>> mapper) {
    this.mapper = mapper;
