...
class RecoverMultiThreadedFuture<T> extends MultiThreadedFutureImpl<T> {

  private final Function<Throwable, Future<T>> mapper;

  public RecoverMultiThreadedFuture(final Future<T> src, final Function<Throwable, Future<T>> mapper) {
    this.mapper = mapper;
