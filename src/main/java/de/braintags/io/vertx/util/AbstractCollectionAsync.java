...
public abstract class AbstractCollectionAsync<E> implements CollectionAsync<E> {
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#containsAll(de.braintags.io.vertx.util.util.CollectionAsync,
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#toArray(io.vertx.core.Handler)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#add(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#remove(java.lang.Object)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#addAll(de.braintags.io.vertx.util.util.CollectionAsync)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#removeAll(java.util.Collection)
   */
  @Override
   ...
   * (non-Javadoc)
   * 
   * @see de.braintags.io.vertx.util.util.CollectionAsync#clear()
   */
  @Override
  public void clear() {
    throw new UnsupportedOperationException();
